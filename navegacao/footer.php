...
<footer>
	...
	<div class="row text-center">
		<div class="col-md-4">
			...
			<hr class="light">
			<p class="text-white">(11)4002-8922</p>
			<p class="text-white">easyprojetos.info@gmail.com</p>
			<p class="text-white">Rua Virgínea Ferni 400</p>
			<p class="text-white">São Paulo - SP, 03178-200</p>
		</div>
		<div class="col-md-4">
			<hr class="light">
		...
		<div class="col-md-4">
			...
			<div class="footerli">
				<ul>
				<li><a href="index.php" class="text-white">Página Inicial</a></li>
				<li><a href="Sobre.php" class="text-white">Sobre</a></li>
				<li><a href="https://invictusprime.com.br/quiz/verTemas.php" class="text-white">Ver Quizzes</a></li>
				<li><a href="perfil.php" class="text-white">Meu Perfil</a></li>
				<li><a href="autenticacao/login.php" class="text-white">Entrar</a></li>
				</ul>
			</div>
			</div>
		<div class="col-12">
			<hr class="light-100">
			<h5 class="text-white">&copy;Invictus Prime - <a href="" data-toggle="modal" data-target="#exampleModalCenter"> Todos os Direitos Reservados.</h5></a>
...
Esse site é operado pelo Easy Projetos. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Easy Projetos. O Easy Projetos proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.
...
Esses Termos de serviço e quaisquer acordos separados em que nós lhe fornecemos os Serviços devem ser regidos e interpretados de acordo com as leis de R. Virgínia Ferni, São Paulo, SP, 03178-200, Brazil.
...
As perguntas sobre os Termos de serviço devem ser enviadas para nós através do Easyprojetos.info@gmail.com.
