		...
		<div class="divPrincipal">
			...
			<div class="container">
                ...
                if(count($verificaSeTemQuiz) > 0){
                  ...
                  $jafez = $verSeJaFez->select("SELECT * FROM resposta_autenticacao WHERE COD_USUARIO = :CODUSUARIO", array(
                                              ":CODUSUARIO"=>$_SESSION['cod_usuario']
                                              ));
                  if(count($jafez) > 0){
                    echo "
                        <div class='divQuerAutenticar'>
                          <center>
                            ...
                            <h5>Suas respostas para o Quiz de Autenciação foram enviadas!</5>
                            <h6>Logo, logo a sua avaliação aparecerá aqui, fique no aguardo é rapido!</h6>
                          </center>
                        </div>
                        ";
                  }else{
                    echo "
                      ...
                      <center>
                        ...
                        <h6>Para fazer este Quiz clique no botão abaixo!</h6>
                          ...
                          <a href='quiz/quizAutenticacao.php' class='btn btn-outline-info float-center'>Responder Quiz de Autenticação</a>
                        </center>
                      </div>
                        ";  
                  }
